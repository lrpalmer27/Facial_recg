# from https://github.com/noxouille/rt-mrcnn/blob/master/run_webcam.py
...
from Face_trainer import IceConfig as config
...
ModelPath = os.path.join(ROOT_DIR, "LogansPeopleFaces.h5")
